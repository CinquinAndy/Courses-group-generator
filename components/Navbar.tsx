...
export default function Navbar() {
	...
	return (
		<div className="navbar sticky top-0 z-10 bg-base-100 md:mx-auto" data-aos="fade-up">
			<div className="navbar-start">
				<div className="dropdown">
					<button type="button" tabIndex={0} className="btn btn-ghost md:hidden" data-cy="dropdownBtn">
						<svg
					...
					<ul className="menu-compact menu dropdown-content rounded-box mt-3 w-52 bg-base-100 p-2 shadow">
						<li>
						...
						<li>
							<div className="form-control">
								<label className="flex-start label flex cursor-pointer" data-cy="darkModeMobile">
									<span className="label-text mx-3">Theme</span>
									<input type="checkbox" className="toggle" onChange={toggleDarkMode} checked={dark} />
								</label>
							</div>
						</li>
					</ul>
